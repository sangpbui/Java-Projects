...
import javax.sound.sampleda.DataLine;
...
public class EasySound {
	...
	public void play() {
		...
		if (line != null) line.write(audioBytes, 0, numBytes);
		else System.out.println("La-la-la (the audio line is unavailable on this computer)");
	}
}
